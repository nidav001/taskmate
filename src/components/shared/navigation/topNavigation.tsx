...
export default function TopNaviagtion() {
        ...
        <>
          ...
          <Transition as={Fragment} {...sideMenu}>
            <Menu.Items
              ...
              className="absolute left-0 top-20 w-full bg-white px-4 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-slate-700 md:w-60"
            >
              <NavigationMenu />
            </Menu.Items>
          </Transition>
  ...
  return (
    <div className="min-w-screen sticky top-0 z-10 flex h-20 items-center justify-between gap-2 border-b bg-gray-100 px-4 dark:border-slate-900 dark:bg-slate-700">
      {MainMenuButton}
      <Logo />
      {ProfileMenuButton}
    </div>
