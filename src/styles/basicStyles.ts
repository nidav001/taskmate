...
export const disabledButtonStyle =
  "rounded-full bg-amber-400 p-2 focus:outline-none active:bg-opacity-60 font-medium backface-visibility-hidden text-sm dark:text-gray-100 dark:bg-amber-600 bg-gray-300";
